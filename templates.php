            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 template-card shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="create-cv.php?template=classic" class="btn btn-primary w-100 mt-3">Use This Template</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 template-card shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="create-cv.php?template=minimalist" class="btn btn-primary w-100 mt-3">Use This Template</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 template-card shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="create-cv.php?template=creative" class="btn btn-primary w-100 mt-3">Use This Template</a>
                    </div>
                </div>
            </div>
